...
public class ChangeLocationCustomer extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMyLocationClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_location_customer);
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    mapFragment.getMapAsync(ChangeLocationCustomer.this);
                }
            }
        });
    }
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        ...
                        Intent intent = new Intent(ChangeLocationCustomer.this, Main2Activity.class);
